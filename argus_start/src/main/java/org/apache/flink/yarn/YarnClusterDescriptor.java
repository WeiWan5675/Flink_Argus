...
import static org.weiwan.argus.start.FlinkPerJobUtil.*;
...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
    ...
    private ClusterClientProvider<ApplicationId> deployInternal(
        ...
        if (clusterSpecification.isCreateProgramDelay()) {
            ...
            String pluginLoadMode = clusterSpecification.getConfiguration().getString(ArgusConstans.FLINK_PLUGIN_LOAD_MODE_KEY);
            if (StringUtils.equalsIgnoreCase(pluginLoadMode, ArgusConstans.SHIP_FILE_PLUGIN_LOAD_MODE)) {
