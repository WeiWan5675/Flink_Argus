 ...
 * @Description:
 **/
public class OplogInputFormat extends BaseRichInputFormat<DataRecord<DataRow<Object>>, OplogInputSpliter> {
    ...
    @Override
    public DataRecord<DataRow<Object>> nextRecordInternal(DataRecord<DataRow<Object>>  row)  {
        DataRecord<DataRow<Object>>  rowDataRecord = new DataRecord();
        ...
        while(iterator.hasNext()){
            //处理数据
            next = iterator.next();
            BsonTimestamp ts = (BsonTimestamp) next.get("ts");
...
//    }
    ...
    public void configure(Configuration parameters) {
        ...
        String[] analysisTablenameArray = readerConfig.getStringVal(KEY_READER_ANALYSIS_TABLENAME, "").split(",");
        this.analysisTablename = analysisTablenameArray;
