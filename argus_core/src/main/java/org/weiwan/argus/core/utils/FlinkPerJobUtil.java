...
import org.weiwan.argus.common.utils.ValueUtil;
    ...
    public static String getUrlFormat(YarnConfiguration yarnConf, YarnClient yarnClient) {
        ...
        try {
            ...
            try {
                ...
                LOG.warn("get currentProxy error:{}", e.getMessage());
            ...
            String key = ArgusConstans.YARN_RESOURCE_MANAGER_WEBAPP_ADDRESS_KEY + "." + proxyInfoKey;
            String addr = yarnConf.get(key);

            if (addr == null) {
                addr = yarnConf.get(ArgusConstans.YARN_RESOURCE_MANAGER_WEBAPP_ADDRESS_KEY);
            }
